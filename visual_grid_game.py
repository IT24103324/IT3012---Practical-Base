...
class VisualGridHuntGame:
    ...
    def execute_action(self, action: str):
        ...
        if action == 'Up':
            new_pos[1] = min(self.height - 1, self.agent_pos[1] + 1)
...
if __name__ == "__main__":
    ...
    # Try a larger grid size like 12x12
    # with 15 food and 3 opponents.
    app = GridGameGUI(
        root,
        width=12,
        height=12,
